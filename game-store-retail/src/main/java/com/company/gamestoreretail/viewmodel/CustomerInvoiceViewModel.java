...
public class CustomerInvoiceViewModel {
    ...
    public CustomerInvoiceViewModel(Integer invoice_id, @Pattern(regexp = "[\\s]*[0-9]*[1-9]+", message = "Id must be positive") Integer customer_id, LocalDate purchase_date, @NotBlank(message = "Please provide a list of invoice items") List<InvoiceItem> invoiceItems, @Pattern(regexp = "[\\s]*[0-9]*[1-9]+", message = "Id must be positive") Integer points) {
    ...
    public boolean equals(Object o) {
        ...
        CustomerInvoiceViewModel that = (CustomerInvoiceViewModel) o;
